...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⚡ How To Download ⚡", url="https://t.me/ak_backup_72/13")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              ...
                              InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Ak74400")
                             ]
                            ]
                        )
                    )
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('♚ Bᴏᴛ Oᴡɴᴇʀ', callback_data="https://t.me/Ak74400"),
                    InlineKeyboardButton('⌬ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url=GRP_LNK)
                ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Ak74400")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
